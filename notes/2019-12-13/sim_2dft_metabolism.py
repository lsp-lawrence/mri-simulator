...
if print_freq_shift:
    lac_sigma = conversion_dict['lac_sigma']
    bw = 1/kread_time
    delta_f = gyromagnetic_ratio*lac_sigma*main_field/(2*np.pi)
    print('bw per pixel: ' + str(bw) + ' Hz')
    print('frequency shift : ' + str(delta_f) + ' Hz')
    print('floor{delta_f/bw} = ' + str(int(delta_f/bw)))
