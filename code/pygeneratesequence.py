...
def see_2DFT_sequence(pulse_sequence):
    """Creates a plot of the 2DFT pulse sequence with excitation and readout
    Params:
        pulse_sequence: (list of Pulse objects) a 2DFT pulse sequence generated by generate_2DFT_sequence
    """
    # Check params
    if not(isinstance(pulse_sequence,list) and all([isinstance(item,Pulse) for item in pulse_sequence])):
